...
## Overview
Hamro Books is an online book shopping store where customers can buy books of various kinds. This Database Management System (DBMS) project was developed as part of a coursework assignment to showcase the integration of frontend, backend, and database management.
...
6. **Access the website**:
    Open your browser and go to [Hamro Books](https://hamro-books.onrender.com/).
...
## Links
- **Website**: [Hamro Books](https://hamro-books.onrender.com/)
- **GitHub Repository**: [Hamro Books on GitHub](https://github.com/pratik-writer/Hamro-Books)
- **Demo Video**: [Watch Demo](https://drive.google.com/file/d/1EA2RBf2M0UwWIgL1QRuiCSTZTIQpfNBx/view?usp=sharing)
